...
Path('./Outputs/Proj_Heads/Rech/20_Percent').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    os.chdir(working_folder)
    JanHeads.to_csv('./Outputs/Proj_Heads/Rech/20_Percent/JanAnnHeads_Run_%s.csv' % (lhs.Run[a]), 
                    index = None)


Path('./Outputs/Proj_Heads/Rech/30_Percent').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    os.chdir(working_folder)
    JanHeads.to_csv('./Outputs/Proj_Heads/Rech/30_Percent/JanAnnHeads_Run_%s.csv' % (lhs.Run[a]), 
                    index = None)
...
#%% No Reduction
Path('./Outputs/Proj_Heads/Rech_No_Red/20_Percent').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    os.chdir(working_folder)
    JanHeads.to_csv('./Outputs/Proj_Heads/Rech_No_Red/20_Percent/JanAnnHeads_Run_%s.csv' % (lhs.Run[a]), 
                    index = None)


Path('./Outputs/Proj_Heads/Rech_No_Red/30_Percent').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    os.chdir(working_folder)
    JanHeads.to_csv('./Outputs/Proj_Heads/Rech_No_Red/30_Percent/JanAnnHeads_Run_%s.csv' % (lhs.Run[a]), 
                    index = None)