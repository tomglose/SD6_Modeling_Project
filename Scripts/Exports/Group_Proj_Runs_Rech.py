...
for i in range(0, len(lhs), 1):
    ...
    AnnHeads = pd.read_csv('./Outputs/Proj_Heads/Rech_No_Red/20_Percent/'
...
Path('./Evaluation_Data/Projection/Rech/').mkdir(parents = True, exist_ok = True)


Accept_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_HC_20_No_Red.csv')
Accept_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Heads_20_No_Red.csv')

Accept_Full_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_HC_20_No_Red.csv')
Accept_Full_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_Heads_20_No_Red.csv') 
...
Accept_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_HC_20.csv')
Accept_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Heads_20.csv')

Accept_Full_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_HC_20.csv')
Accept_Full_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_Heads_20.csv') 
...
Accept_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_HC_30_No_Red.csv')
Accept_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Heads_30_No_Red.csv')

Accept_Full_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_HC_30_No_Red.csv')
Accept_Full_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_Heads_30_No_Red.csv') 
...
Accept_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_HC_30.csv')
Accept_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Heads_30.csv')

Accept_Full_HC_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_HC_30.csv')
Accept_Full_Heads_No_Red.to_csv('./Evaluation_Data/Projection/Rech/Accept_Full_Heads_30.csv')
