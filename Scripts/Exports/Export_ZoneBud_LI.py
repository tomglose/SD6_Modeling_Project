...
Path('./Outputs/Zone_Budgets/LI/20_Percent/').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    zb_1.to_csv('./Outputs/Zone_Budgets/LI/20_Percent/'
     'Zon1_Run_%s.csv' % (lhs.Run[a]))
    zb_2.to_csv('./Outputs/Zone_Budgets/LI/20_Percent/'
     'Zon2_Run_%s.csv' % (lhs.Run[a]))
    zb_3.to_csv('./Outputs/Zone_Budgets/LI/20_Percent/'
     'Zon3_Run_%s.csv' % (lhs.Run[a]))    
    
    
Path('./Outputs/Zone_Budgets/LI/30_Percent/').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    zb_1.to_csv('./Outputs/Zone_Budgets/LI/30_Percent/'
     'Zon1_Run_%s.csv' % (lhs.Run[a]))
    zb_2.to_csv('./Outputs/Zone_Budgets/LI/30_Percent/'
     'Zon2_Run_%s.csv' % (lhs.Run[a]))
    zb_3.to_csv('./Outputs/Zone_Budgets/LI/30_Percent/'
     'Zon3_Run_%s.csv' % (lhs.Run[a]))    



Path('./Outputs/Zone_Budgets/LI_No_Red/20_Percent/').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    zb_1.to_csv('./Outputs/Zone_Budgets/LI_No_Red/20_Percent/'
     'Zon1_Run_%s.csv' % (lhs.Run[a]))
    zb_2.to_csv('./Outputs/Zone_Budgets/LI_No_Red/20_Percent/'
     'Zon2_Run_%s.csv' % (lhs.Run[a]))
    zb_3.to_csv('./Outputs/Zone_Budgets/LI_No_Red/20_Percent/'
     'Zon3_Run_%s.csv' % (lhs.Run[a])) 
    
    
Path('./Outputs/Zone_Budgets/LI_No_Red/30_Percent/').mkdir(parents = True, exist_ok = True)
...
for a in range(0, len(lhs), 1):
    ...
    zb_1.to_csv('./Outputs/Zone_Budgets/LI_No_Red/30_Percent/'
     'Zon1_Run_%s.csv' % (lhs.Run[a]))
    zb_2.to_csv('./Outputs/Zone_Budgets/LI_No_Red/30_Percent/'
     'Zon2_Run_%s.csv' % (lhs.Run[a]))
    zb_3.to_csv('./Outputs/Zone_Budgets/LI_No_Red/30_Percent/'
     'Zon3_Run_%s.csv' % (lhs.Run[a])) 