...
for k in range(0, len(lhs), 1):
    ...
    Path('./Data/Projection/Rech_No_Red/20_Percent/%s' % (modelname)).mkdir(parents = True, 
                                                          exist_ok = True)
    os.chdir('./Data/Projection/Rech_No_Red/20_Percent/%s' % (modelname))
...
for k in range(0, len(lhs), 1):
    ...
    # set up folder to save data to
    Path('./Data/Projection/Rech_No_Red/30_Percent/%s' % (modelname)).mkdir(parents = True, 
                                                          exist_ok = True)
    os.chdir('./Data/Projection/Rech_No_Red/30_Percent/%s' % (modelname))
